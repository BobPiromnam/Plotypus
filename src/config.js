  ...
  const defaultConfig = {
    ...
    boundarySources: {
      canada: {
        ...
        fallbackUrl: "data/boundaries/canada-regions.geojson",
        fallbackKey: "canada",
        projection: "canada"
      },
      world: {
        ...
        fallbackUrl: "data/boundaries/world-countries.geojson",
        fallbackKey: "world",
        projection: "world"
      }
    },
    ...
    regionPresetOptions: {
      ...
      world: [
        ...
        { value: "united-states", label: "United States", labelFr: "États-Unis" },
        { value: "arctic", label: "Arctic countries", labelFr: "Pays de l'Arctique" },
